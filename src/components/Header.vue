    ...
    simpleSuggestionList(inputValue) {
      return new Promise((resolve, reject) => {
        var options = {
          ...
          headers: {
            'x-api-key': '54dcfF0kfO9N10vcrzKGckVQMVAMyVF7PINjpWk9'/*'HiM52JbWwbaeAZkIE8Hhm4gsVEuwpMpf6GH938Vi' */ /*'PuVH8SoMIv8bs36EjW8s2aDlXXATRXXX4r4uNCJ3' */ /* 'yJr0Oo6vNO5K6LwQRB3ww2oByOQS1uji4d5HVBDz' */ /* 'ZV9PsSTYb02VX78B6t87saQCLLrAVTW15uBrKfRi' */  /*'6FRpNzPo591vXM5ri8Zgq1B3PDpOuYpTqgNAT7T4'*/
          }
        }
