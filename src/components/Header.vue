    ...
    simpleSuggestionList(inputValue) {
      return new Promise((resolve, reject) => {
        var options = {
          ...
          headers: {
            'x-api-key': /*'HiM52JbWwbaeAZkIE8Hhm4gsVEuwpMpf6GH938Vi' */ /*'PuVH8SoMIv8bs36EjW8s2aDlXXATRXXX4r4uNCJ3' */ /* 'yJr0Oo6vNO5K6LwQRB3ww2oByOQS1uji4d5HVBDz'*/ 'Nxsrr9ch5zLkI6PiE30B4mrLpYo0bw23hjUVzcx0'/* '6FRpNzPo591vXM5ri8Zgq1B3PDpOuYpTqgNAT7T4''' /*'6FRpNzPo591vXM5ri8Zgq1B3PDpOuYpTqgNAT7T4'*/
          }
        }
